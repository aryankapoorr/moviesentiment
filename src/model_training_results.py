...
def model_training_results_page():
    ...
    st.write("\n\nAfter observing the distribution of data points in the smaller test size, it became clear that there was no obvious boundary to discern between positive and negative reviews. Therefore, generating a score for a review was done with the decimal score, instead of a binary positive/negative.")
